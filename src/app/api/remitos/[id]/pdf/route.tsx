      ...
      <DeliveryNotePdfDocument
        data={{
          ...
          organization: {
            ...
            address: note.organization.address,
            phone: note.organization.phone,
            email: note.organization.email,
            website: note.organization.website,
            socialMedia: note.organization.socialMedia,
          },
          receiver,
