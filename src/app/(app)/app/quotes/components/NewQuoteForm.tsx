          ...
          <div className="field-stack">
            <div className="field-stack">
              ...
              <label className="mt-2 flex items-center gap-2 text-xs text-zinc-600">
                <input
                  type="checkbox"
                  checked={isConsumerFinalAnonymous}
                  onChange={(event) => onConsumerFinalToggle(event.target.checked)}
                  disabled={isResolvingConsumerFinal || isSubmitting}
                />
                Consumidor final (sin identificar)
              </label>
              <p className="text-[11px] text-zinc-500">
                Para montos menores a ${consumerFinalThresholdLabel} podes operar sin
                datos. Si supera el umbral, se pedira confirmacion.
              </p>
              <p className="text-[11px] text-zinc-500">
                Si el receptor quiere deduccion de Ganancias, la identificacion se
                valida al facturar.
              </p>
              {showConsumerFinalThresholdWarning ? (
